...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<middleman-core>.freeze, ["= 4.6.0".freeze])
  s.add_runtime_dependency(%q<middleman-cli>.freeze, ["= 4.6.0".freeze])
end
